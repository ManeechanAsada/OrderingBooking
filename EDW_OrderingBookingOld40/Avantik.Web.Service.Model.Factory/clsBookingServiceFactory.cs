...
{
    public static class BookingServiceFactory 
    {
        public static Model.Contract.IBookingModelService CreateInstance()
        {
            ...
            //    return new Model.COM.BookingModelService(server, user, password, domain);
            //}
            //else
            //{
