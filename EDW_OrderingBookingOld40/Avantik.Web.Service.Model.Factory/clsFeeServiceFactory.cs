...
{
    public static class FeeServiceFactory 
    {
        public static Model.Contract.IFeeService CreateInstance()
        {
            ...
            if (useCOM == true)
            {
                ...
                return new Model.COM.FeeService(server, user, password, domain);
            }
            else
            {
